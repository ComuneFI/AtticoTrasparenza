...
@Component({
  selector: 'app-cerca-del',
  templateUrl: './cerca-del.component.html',
  styleUrls: ['./cerca-del.component.scss']
})
export class CercaDelComponent implements OnInit {
  isLoading: boolean;
  queryJson: any = {};
  queryParams: any = {};
  uffici: string[] = [];
  ...
  @ViewChild('tabellaDel') tabellaDel: TabellaDelComponent;
  ...
  constructor(
      ...
      for (const item of filters.select.deliberazioni.tipoAtti) {
  ...
  search(e: any): void {
      ...
      if (this.selectUffici.nativeElement.selectedIndex &&
        !isNaN(this.selectUffici.nativeElement.selectedIndex) && this.selectUffici.nativeElement.options[this.selectUffici.nativeElement.selectedIndex]) {
      ...
      if (this.selectRelatori.nativeElement.selectedIndex &&
        !isNaN(this.selectRelatori.nativeElement.selectedIndex) && this.selectRelatori.nativeElement.options[this.selectRelatori.nativeElement.selectedIndex]) {
      ...
      if (this.selectCompetenza.nativeElement.selectedIndex &&
        !isNaN(this.selectCompetenza.nativeElement.selectedIndex) && this.selectCompetenza.nativeElement.options[this.selectCompetenza.nativeElement.selectedIndex]) {
      ...
      if (this.selectAnnoAdozione.nativeElement.selectedIndex &&
        !isNaN(this.selectAnnoAdozione.nativeElement.selectedIndex) && this.selectAnnoAdozione.nativeElement.options[this.selectAnnoAdozione.nativeElement.selectedIndex]) {
      ...
      if (this.selectMeseAdozione.nativeElement.selectedIndex &&
        !isNaN(this.selectMeseAdozione.nativeElement.selectedIndex) && this.selectMeseAdozione.nativeElement.options[this.selectMeseAdozione.nativeElement.selectedIndex]) {
      ...
      this.tabellaDel.onSearch(this.queryJson, this.defaultLstTipoAtto);
  ...
  reset(e: any): void {
      ...
      this.queryJson = {};
      this.tabellaDel.onReset(this.queryJson);
  }
