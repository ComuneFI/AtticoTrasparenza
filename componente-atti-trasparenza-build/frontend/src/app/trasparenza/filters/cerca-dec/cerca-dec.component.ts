...
@Component({
  selector: 'app-cerca-dec',
  templateUrl: './cerca-dec.component.html',
  styleUrls: ['./cerca-dec.component.scss']
})
export class CercaDecComponent implements OnInit {
  isLoading: boolean;
  queryJson: any = {};
  queryParams: any = {};
  uffici: string[] = [];
  ...
  @ViewChild('tabellaDec') tabellaDec: TabellaDecComponent;
  ...
  search(e: any): void {
      ...
      this.tabellaDec.onSearch(this.queryJson);
  ...
  reset(e: any): void {
      ...
      this.queryJson = {};
      this.tabellaDec.onReset(this.queryJson);
  }
