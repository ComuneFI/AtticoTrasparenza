...
@Component({
  selector: 'app-cerca-ord',
  templateUrl: './cerca-ord.component.html',
  styleUrls: ['./cerca-ord.component.scss']
})
export class CercaOrdComponent implements OnInit {
  isLoading: boolean;
  queryJson: any = {};
  queryParams: any = {};
  uffici: string[] = [];
  ...
  @ViewChild('tabellaOrd') tabellaOrd: TabellaOrdComponent;
  ...
  constructor(
      ...
      for (const item of filters.select.ordinanze.tipoAtti) {
  ...
  search(e: any): void {
      ...
      this.tabellaOrd.onSearch(this.queryJson);
  ...
  reset(e: any): void {
      ...
      this.queryJson = {};
      this.tabellaOrd.onReset(this.queryJson);
  }
