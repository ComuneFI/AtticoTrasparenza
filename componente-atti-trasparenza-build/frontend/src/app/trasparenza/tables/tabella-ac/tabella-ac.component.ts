...
@Component({
  selector: 'app-tabella-ac',
  templateUrl: './tabella-ac.component.html',
  styleUrls: ['./tabella-ac.component.scss']
})
export class TabellaAcComponent implements OnInit, OnDestroy {
  json_list: any[] = [];
  columns: string[] = [];
  columnLabels: string[] = [];
  isLoading: boolean;
  ...
  constructor(private http: HttpClient,
        ...
        this.columnLabels = [
            this.translateService.instant('columnLabels')['number'],
            this.translateService.instant('columnLabels')['presentationDate'],
            this.translateService.instant('columnLabels')['approvalDate'],
            this.translateService.instant('columnLabels')['expiryDate'],
            // this.translateService.instant('columnLabels')['subtype'],
            this.translateService.instant('columnLabels')['status'],
            this.translateService.instant('columnLabels')['outcome'],
            this.translateService.instant('columnLabels')['assessor'],
            // this.translateService.instant('columnLabels')['commission'],
            this.translateService.instant('columnLabels')['proponent'],
