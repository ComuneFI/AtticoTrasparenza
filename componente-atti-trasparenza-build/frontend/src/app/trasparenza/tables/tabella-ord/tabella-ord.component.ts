...
@Component({
  selector: 'app-tabella-ord',
  templateUrl: './tabella-ord.component.html',
  styleUrls: ['./tabella-ord.component.scss']
})
export class TabellaOrdComponent implements OnInit, OnDestroy {
  json_list: any[] = [];
  columns: string[] = [];
  columnLabels: string[] = [];
  isLoading: boolean;
