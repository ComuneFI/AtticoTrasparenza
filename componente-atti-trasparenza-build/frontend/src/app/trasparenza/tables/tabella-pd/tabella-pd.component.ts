...
@Component({
  selector: 'app-tabella-pd',
  templateUrl: './tabella-pd.component.html',
  styleUrls: ['./tabella-pd.component.scss']
})
export class TabellaPdComponent implements OnInit, OnDestroy {
  json_list: any[] = [];
  columns: any = [];
  columnLabels: string[] = [];
  isLoading: boolean;
  ...
  public retrieveData(): number {
    ...
    private setData(list: any): void {
          ...
          if (list[i] != null) {
            ...
            for (const key in obj) {
                 ...
                 if (key === 'allegati') {
                     ...
                     obj[key.data] = {
                       'display': obj[key.data],
                       'timestamp': obj[key.data]
                     };
        ...
        // console.log('TEST', this.json_list);
    }
