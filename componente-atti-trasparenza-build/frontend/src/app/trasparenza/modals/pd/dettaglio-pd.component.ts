...
@Component({
  selector: 'app-dettaglio-pd',
  templateUrl: './dettaglio-pd.component.html',
  styleUrls: ['./dettaglio-pd.component.scss']
})
export class DettaglioPdComponent implements OnInit, OnDestroy {
